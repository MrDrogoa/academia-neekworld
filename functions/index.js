...
console.log('🔍 Variables de entorno cargadas:', {
  ...
  KHIPU_ENVIRONMENT: process.env.KHIPU_ENVIRONMENT,
...
const advancedCourseRoutes = require('./routes/advancedCourses');
const advancedPaymentRoutes = require('./routes/advancedPayments');
...
app.use('/courses-advanced', advancedCourseRoutes);
app.use('/payments-advanced', advancedPaymentRoutes);
...
app.use('/payments/khipu', khipuRoutes);
app.use('/payments/flow', flowRoutes);
