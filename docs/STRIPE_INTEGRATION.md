...
STRIPE_ENABLED=true
STRIPE_SECRET_KEY=sk_test_[TU_TESTING_KEY] # Testing key
STRIPE_PUBLIC_KEY=pk_test_[TU_FRONTEND_KEY] # Frontend key
STRIPE_WEBHOOK_SECRET=whsec_[TU_WEBHOOK_SECRET] # Webhook signing secret
```
